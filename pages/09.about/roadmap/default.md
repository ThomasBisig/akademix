...
- [ ] clean tag structure (again)
- [ ] Think about and implement structure for
	- [ ] Sets of exercises
	- [ ] Relationships and dependencies of topics
	- [ ] Make id, pair and set? or collection?
- [ ] Add 'basale Kompetenzen' exercises

#### Later

- [ ] Eigenen Schwierigkeitsindikator verbessern bzw. gut überlegen wie...
- [ ] Eigenen Aufwandsindikator verbessern (Schätzung und #Schritte -> 10-15')
...
- [ ] Make link per page to download markdown file, word and qr code (Plugin? or input: https://discourse.getgrav.org/t/provide-page-for-download-and-change-content-type/2066/2)
...
### Completed
- [-] Make each one an object: exercise, hint, solution, worked solution (-> not for now) (20230912)
- [-] Collections oder Aufgabensammlungen? -> see 'implement structure' (20230912)
- [x] Front page with example exercise (?) (08.05.23)
- [x] Images to grav-plugin-featherlight (->don't)
...
- [x] Not yet nice collapsible 'more exercises' (20230813)
- [x] Kind of exercise as icon (hack) (20230813)
